...
class LineImage:
    ...
    def generateMask(self):
        # Generate Mask
        blurred = cv2.GaussianBlur(self.tempImg, (7,7), 0)
    ...
    def morph(self, dilKernel, eroKernel, dilIter, eroIter):
        ...
        kernel1 = np.ones((dilKernel,dilKernel), np.uint8)
        kernel2 = np.ones((eroKernel,eroKernel), np.uint8)
...
image = LineImage(path2img)

# Line 1: Upper
image.setSection(2800, 3890, 200, 3800)
# image.showImage('section')
image.generateMask()
# image.showImage('mask')
image.threshold(200)
# image.showImage('threshold')
image.morph(7,2,3,2)
# image.showImage('morph')
image.contour()
# image.showImage('contour')
image.gaussian(30)
# image.showImage('gaussian')
image.getLine(1)

# Line 2: Lower
image.setSection(3180, 5475, 340, 3860)
image.generateMask()
image.threshold(200)
image.morph(7,2,3,3)
image.contour()
